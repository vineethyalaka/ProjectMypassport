...
<?php
$page_title = 'Welcome Organizations';
...
<p>NJIT prepares its graduates for positions of leadership  as professionals and as citizens. Our mission identifies NJIT as the states technological research university , committed to the pursuit of excellence - - in service to 
	...
	<button class="btn btn-1 btn-1a"><a href="createAccount.php">Create a MyPassport Account</a></button><br>
	<button class="btn btn-1 btn-1a"><a href="loginUser.php?acc=Organization"> Login to myPassport</a></button><br>
